...
-The 'settings.cfg' that is generated when you run the script the first time (or whenever you purosefully delete it and run the script again if you want to restore defaults) holds a few useful options that can help you customize this script's function. <br /> <br />
